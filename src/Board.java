public class Board {
    ...
    private boolean[] occupied = new boolean [Constants.NUM_COUNTRIES];
    private int[] occupier = new int [Constants.NUM_COUNTRIES];
    private int[] numUnits = new int [Constants.NUM_COUNTRIES];
